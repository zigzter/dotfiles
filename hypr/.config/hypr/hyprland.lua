...
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd('grim -g "$(slurp -o)" - | tee ~/screenshots/$(date +\'%s_grim.png\') | wl-copy'), { locked = true })
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("grim - | tee ~/screenshots/$(date +'%s_grim.png') | wl-copy"), { locked = true })
