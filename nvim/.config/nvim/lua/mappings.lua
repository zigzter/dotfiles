...
local function vmap(lhs, rhs, desc) vim.keymap.set("v", lhs, rhs, { noremap = true, silent = true, desc = desc }) end
...
nmap("<leader>sw", Snacks.picker.grep_word, "[s]earch current [w]ord")
nmap("<leader>sg", Snacks.picker.grep, "[s]earch by [g]rep")
nmap("<leader>sb", Snacks.picker.buffers, "[s]earch [b]uffers")
nmap("<leader>sh", Snacks.picker.help, "[s]earch [h]elp")
nmap("<leader>sk", Snacks.picker.keymaps, "[s]earch [k]eymaps")
nmap("<leader>ss", Snacks.picker.lsp_symbols, "[s]earch [s]ymbols")
nmap("<leader>sr", Snacks.picker.lsp_references, "[s]earch lsp [r]eferences")
nmap("<leader>sl", Snacks.picker.resume, "[s]earch [l]ast")
nmap("<leader>sm", Snacks.picker.marks, "[s]earch [m]arks")
nmap("<leader>sq", Snacks.picker.qflist, "[s]earch [q]uickfix")
nmap("<leader>sy", Snacks.picker.registers, "[s]earch [y]anks (registers)")
nmap("<leader>sc", Snacks.picker.git_log_file, "[s]earch [c]ommits (current buffer)")
nmap("<leader>sd", Snacks.picker.git_status, "[s]earch [d]iff")
nmap("<leader>st", function() Snacks.picker.todo_comments() end, "[s]earch [t]odos")
nmap("<leader>/", Snacks.picker.lines, "[/] Fuzzily search in current buffer")
nmap("<leader>sn", function() Snacks.picker.files({ cwd = vim.fn.stdpath("config") }) end, "[s]earch [n]eovim config")
nmap("<leader>ad", Snacks.picker.diagnostics, "Show [a]ll buffer [d]iagnostics")
nmap("<leader>bd", Snacks.picker.diagnostics_buffer, "Show [b]uffer [d]iagnostics")
...
nmap("<leader>y", '"+y', "Yank to system clipboard (operator)")
nmap("<leader>Y", '"+Y', "Yank line to system clipboard")
vmap("<leader>y", '"+y', "Yank selection to system clipboard")
